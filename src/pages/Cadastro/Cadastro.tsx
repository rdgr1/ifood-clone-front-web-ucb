  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if ((res.status === 201 || res.status === 200) && token) {
        ...
        let rotaInicial = "/cliente/restaurantes";
        if (tipo === "loja") rotaInicial = "/loja/produtos";
        if (tipo === "entregador") rotaInicial = "/entregador/pedidos";

        setTimeout(() => navigate(rotaInicial), 2000);
      } else {
